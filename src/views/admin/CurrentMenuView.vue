    ...
    <div class="container mx-auto w-11/12 md:w-full grid grid-cols-2 gap-2 md:gap-8 lg:grid-cols-3 mt-8">
        ...
        <div class="px-5 pb-5">
            ...
            <div class="flex flex-col md:flex-row mt-1 gap-1 md:gap-2 md:mt-4">
                <button class="mt-2 md:mt-0 md:w-full text-white bg-blue-400 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs md:text-sm px-5 py-1 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Editar</button>
